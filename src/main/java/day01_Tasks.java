...
public class day01_Tasks {
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to the Currency Converter! convert USD to EUR");
        ...
        System.out.println("Welcome to the Substring Extractor!");
        ...
        System.out.println("Welcome to the Keyword Checker!");
        System.out.println("Please enter a sentence: ");
        ...
        System.out.println("Welcome to the Word Replacer!");
        System.out.println("Please enter a sentence: ");
        ...
        System.out.println("Welcome to the String Comparator!");
